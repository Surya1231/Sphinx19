...
<div class="modal fade Robowar  modalevent" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Robowar : Battle of Robots</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
      </div>
      <div class="modal-body">
        <div class="eventdetail_wpr">
         <div class="evencon_box">
            <h3>Overview</h3>
						Robowar, an excellent opportunity to witness the UFC of robot-to-robot combat, where
			...
			engineers facing off each other, Sphinx'19, Robowar is the place to be. Expect intense
			competition as teams fight it out and unleash their fury. Intense matches, fierce competition,
			Destruction and Glory! So come and be part of one of the largest events of Sphinx'19 and be
			amazed.
</div>
          <div class="evencon_box">
            <h3>General Rules</h3>
...
<li>The participation certificate will be awarded to all the participants.</li>
		...
		{
			?>
            <a href="robotics.php?event=Robowar"  class="btn btn-input regist-popshow">Register Now</a>
         <?php } else
		 { ?>
...
<li>Register your team at www.sphinxmnit.in</li>
...
<div class="modal fade Roborush  modalevent" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ROBORUSH</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
      </div>
      <div class="modal-body">
        <div class="eventdetail_wpr">
         <div class="evencon_box">
            <h3>Overview</h3>
Robotics as a whole is a competition where people can showcase their technical skills. Robo- Rush is a competition where a couple of robots compete with each other in their speed and accurate control.
</div>
          <div class="evencon_box">
            <h3>Problem Statement</h3>
			  Teams have to build a wired or wireless Robot that can drag/push the white boxes out of the black circle while traversing the arena full of obstacles and without touching any bomb.
		  </div>
		  
		  <div class="evencon_box">
            <h3>Arena</h3>
            <ul class="checboxlist">
                <li>The game arena consists of a track having 9 obstacle (shown in fig).</li><br><br>
                <center>
	 <img src="images/roborush.png" style="width:50%;">
	 <br>
	 <a href="images/roborush.png" target="_blank"><span style="color:blue">Click here for full size image</span></a><br><br>
 </center>
            <li>The bot must be within the dimensions of 30cm x 30cm x 30cm (l x b x h). Minimum dimensions: 15cm x 15cm x 15cm</li>
            <li>Weight limit: 5 kg.</li>
            <li>The robot should be wired or wireless.</li>
            <li>A power supply of max 12V and 5A can be used.</li>
            <li>AC supply will be provided, participants are required to bring their own adapters and extension boards.</li>
		  ...
		  <div class="evencon_box">
		      ...
		      <ul class="checboxlist">
		          ...
		          <li>Only two team members are allowed to be near the game field.</li>
		          <li>Run will start only when organizers give the signal.</li>
		          <li>Checkpoints are present after every 3 hurdle, participants have to start from previous checkpoint in case of technical timeout, technical timeout will be of 90 seconds and a penalty of 35 seconds will be added (90 seconds are excluded from total time)</li>
		          <li>If bot is stuck at a hurdle, team can skip hurdle by taking penalty of extra 10 seconds while loosing respective bonus time of hurdle or team can restart hurdle with taking penalty of 5 seconds.</li>
		          <li>Oil spill, Hanging Bridge, Bridge, Sew-Saw are of 15 bonus seconds, rest 5 are of 8 bonus seconds.</li>
		          <li>If bot partially goes off track penalty of 5 second will be added whereas in case of whole bot goes off track penalty of 10 seconds will be added.</li>
		          <li>Team with lowest time will be awarded.</li>
		      </ul>
		  ...
		  <div class="evencon_box">
		      <h3>General Rules</h3>
		      <ul class="checboxlist">
		          <li>Only two members of the team are allowed to handle the bot.</li>
		          <li>Participants are not allowed to keep anything inside the arena other than the bot.</li>
		          <li>The time measured by the organizers will be final and will be used for scoring the teams.</li>
		          <li>Time measured by any participant by any other means is not acceptable for scoring.</li>
		          <li>In case of any discrepancies, the organizers decision will be final and binding.</li>
		          <li>The organizers reserve the right to change any or all of the above rules as they deem fit. Change in rules, if any will be highlighted on the website and notified to the registered teams.</li>
		          <li>Register your team at <a href="http://www.sphinxmnit.in/robotics.php">www.sphinxmnit.in</a></li>
		      </ul>
		  </div>
		  ...
		  <div class="evencon_box">
		      <h3>Scoring</h3>
		      Q=Time taken.<br>
		      P= Total penalty time<br>
		      Z= Total hurdle time bonus<br>
		      Total marks = Q-Z+P<br>
		  </div>
            ...
            <div class="pptable">
              <table>
                <tr>
                  <td>Archit sharma</td>
                  <td>8192810770</td>
				  <td>2017uee1474@mnit.ac.in</td>
                </tr>
                <tr>
                  <td>Rahul goyal</td>
                  <td>8808468000</td>
				  <td>2017uee1765@mnit.ac.in</td>
                </tr>
								<tr>
                  <td>Ayush Goyal</td>
                  <td>7014213266</td>
				  <td>2017kuec2037@mnit.ac.in</td>
                </tr>
              </table>
            </div>
          </div>
		...
		{
			?>
            <a href="robotics.php?event=Roborush"  class="btn btn-input regist-popshow">Register Now</a>
         <?php } else
		 { ?>
			 <a href="javascript:;" data-toggle="modal" data-target="#loginbox" class="btn btn-input regist-popshow" data-dismiss="modal">Register Now</a>
		<?php  }?>
      ...
      <div class="ourtemamanin_wrp" style="width:100%;     border-radius:0px 0px 0px 0px; padding-top: 25px;">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12">
                <div class="eventbox_wrp">
                   ...
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">Robowar</div></center>
					<p class="content_p" style="font-family: 'bahnschrift', sans-serif;"><br><b>ZED</b> is electrified by the novel exposure to the robotic zone .He is craving for an enhanced encounter in this territory. He's now well equipped with loyal robots and it's his time to evaluate their skill by calling on for a battle of the ' Battle bots’. But he is longing for worthy opponents. This time he demands a fierce battle field with reckless robo soldiers. Accept his challenge and launch yourself into the world of robots.</p>
                    <div class="event_btn"> <a href="#" class="event_left_btn btn2 btn2-5 btn2-5b icon-more-detail" data-toggle="modal" data-target=".Robowar"><span style="font-family: 'bahnschrift', sans-serif;">More Details</span></a>
                    <?php
		if(isset($_SESSION["user_sphinx_sp"]))
		{
			?>
                    <a href="robotics.php?event=Robowar" class="event_left_btn btn2 btn2-5 btn2-5b icon-register"><span style="font-family: 'bahnschrift', sans-serif;">Register</span></a>
         <?php } else
		 { ?>
		...
		<?php  }?>
			   ...
			   <div class="col-md-12 col-sm-12">
                <div class="eventbox_wrp">
                   <div class="evnt_cont_box">
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">ROBORUSH</div></center>
					<p class="content_p" style="font-family: 'bahnschrift', sans-serif;">We're fascinated by robots because they are reflections of ourselves. <br>
                        Every one of us is amazed by robots shown in movies like Terminator or Transformers. <b>ZED</b> too, is astonished by robots, but he feels that in reality, they are far behind as compared to humans. He thinks that they lack accuracy and control. So we have come up with an event to change his perspective. Take up this challenge to show what robots are actually capable of and do remember we even have prizes for the best ones!</p>
                    <div class="event_btn"> <a href="#" class="event_left_btn btn2 btn2-5 btn2-5b icon-more-detail" data-toggle="modal" data-target=".Roborush"><span style="font-family: 'bahnschrift', sans-serif;">More Details</span></a>
                    <?php
		if(isset($_SESSION["user_sphinx_sp"]))
		{
			?>
                    <a href="robotics.php?event=Roborush" class="event_left_btn btn2 btn2-5 btn2-5b icon-register"><span style="font-family: 'bahnschrift', sans-serif;">Register</span></a>
         <?php } else
		 { ?>
			 <a href="javascript:;" data-toggle="modal" data-target="#loginbox" class="event_left_btn btn2 btn2-5 btn2-5b icon-register"><span style="font-family: 'bahnschrift', sans-serif;">Register</span></a>
		<?php  }?>
			  ...
			  <div class="col-md-12 col-sm-12">
                <div class="eventbox_wrp">
                   <div class="evnt_cont_box">
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">ROBOTRYST</div></center>
					<p class="content_p" style="font-family: 'bahnschrift', sans-serif;"><br>The ambience of robotic era has swayed <b>ZED</b>'s mind towards cyborg's world. He is now keen to delve into the depths of this cyber network. Hence he has planned to conduct the trickiest robotics battle named 'RoboTryst' to build an autonomous robot which is able to win against the given obstacles and is able to crack the defined constraints. He is searching for innovative ideas and wants to be coaxed by the students’ prowess.</p>
                    <div class="event_btn"> <a href="#" class="event_left_btn btn2 btn2-5 btn2-5b icon-more-detail" data-toggle="modal" data-target=".Robotryst"><span style="font-family: 'bahnschrift', sans-serif;">More Details</span></a>
                    <?php
		if(isset($_SESSION["user_sphinx_sp"]))
		{
			?>
                    <a href="robotics.php?event=Robotryst" class="event_left_btn btn2 btn2-5 btn2-5b icon-register"><span style="font-family: 'bahnschrift', sans-serif;">Register</span></a>
         <?php } else
		 { ?>
			 <a href="javascript:;" data-toggle="modal" data-target="#loginbox" class="event_left_btn btn2 btn2-5 btn2-5b icon-register"><span style="font-family: 'bahnschrift', sans-serif;">Register</span></a>
		<?php  }?>
