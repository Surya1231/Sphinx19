            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12">
                <div class="eventbox_wrp">
                   ...
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">Dr. Anukram Mishra</div></center>
                   <br>

                   <img src="images/anu.jpeg" style="width:82%; height:300px">
                  </div>
                </div>
              </div>
			   ...
			   <div class="col-md-4 col-sm-12">
                <div class="eventbox_wrp">
                   <div class="evnt_cont_box">
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">Mr. Raju Sagi</div></center>
                   <br>
                   <img src="images/raju.jpeg" style="width:82%; height:300px">
                  </div>
                </div>
              </div>
			  ...
			  <div class="col-md-4 col-sm-12">
                <div class="eventbox_wrp">
                   <div class="evnt_cont_box">
                   <center> <div class="card_box" style="font-family: 'bahnschrift', sans-serif;">Mr. Sachin Gupta</div></center>
                   <br>
                    <img src="images/sachin.jpeg" style="width:82%; height:300px;">
                  </div>
                </div>
              </div>
