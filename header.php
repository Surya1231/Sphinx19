...
.ppp2{
	    width:100%; height:100%; background:url('https://s3.gifyu.com/images/Rocket.gif') center 10% no-repeat; background-size: contain;
}
/* .ppp3{
...
.ppp2{
	width:100%; height:100%; background:url('https://s3.gifyu.com/images/Rocket.gif') 50% 50% no-repeat; background-size: contain;
}
.ppp3{
	display: none;
...
/*.ppp2{*/
/*	position:absolute; width:50%; height:50%; background:url('images/loader6.gif') center 100% no-repeat; background-size:200%;*/
/*}*/
/*.ppp3{*/
	...
	<div class="homemenu_Wrp">
		...
		<div class="menushowwrp">
			...
			<ul>
				...
				<a href="new-labyrinth.php"><li>Labyrinth</li></a>
				<a href="exhibition.php"><li>Exhibitions</li></a>
				<a href="techtalk.php"><li>Tech Talk</li></a>
				<a href="pronites.php"><li>Pronites</li></a>
				<a href="team.php"><li>Team</li></a>
				<a href="schedule.php" target="_blank"><li>Schedule</li></a>
				<a href="hospitality.php"><li>Hospitality</li></a>
